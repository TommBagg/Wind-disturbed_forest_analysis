# Title: Tree identification and crown extraction in windthrown areas 22/09/2021
...
## tree tops -> lmf Popescu & Wynne (2004)
## crown identification -> silva 2016


##############################
#Algorithm start

las <- readLAS("di91_lieg_dom1_20cm.laz", select = "xyz")
dtm <- raster("dtm_2019_0p2.tif")
...
writeOGR(contour_fin, dsn = wd, layer = "tree_S16_91", driver = "ESRI Shapefile", overwrite_layer=TRUE )
writeOGR(tree_p, dsn = wd, layer = "tree_S16_91_P", driver = "ESRI Shapefile", overwrite_layer=TRUE )
